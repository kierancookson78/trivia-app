...
/**
 * The TimeAttack class is an activity that allows the user to start a time attack quiz.
 ...
 */
class TimeAttack : AppCompatActivity() {
	...
	private fun start() {
		...
		startIntent.putExtra("time_attack", true)
